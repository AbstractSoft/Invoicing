...
namespace Invoicing.Domain.BoundedContexts.Customer;

public sealed class Customer : Support.Contracts.Entities.Entity,
    Support.Contracts.Entities.IAggregateRoot
{
    ...
    {
        return new Invoicing.Domain.BoundedContexts.Customer.Validators.CustomerValidator();
    }
}
